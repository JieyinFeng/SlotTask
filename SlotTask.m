...
function SlotTask(sid,blk,varargin)
  ...
  try
     ...
     %% Instructions     
     Instructions = { ...
        [ 'You will be playing a slot machine\n\n' ...
          'You have to choose from 4 fruits to make the slot machine spin\n\n'...
          'The first fruit is chosen using the button under your index finger\n' ...
          'The button under your middle choses the second fruit\n' ...
          'and so on\n' ...
        ], ...
        [ 'Sometimes you win points\n\n',...
          'Sometimes you won''t\n\n' ...
          'Other times, nothing will happen' ...
        ], ...
        [ 'You can not choose the same fruit twice in a row\n\n' ...
          'The faster you respond, the more chances you get to win\n\n' ...
          'You can win up to $25 in addition to your participation compensation\n\n' ...
        ], ...
      }; 
...
%         end
        ...
        while(response==prevchoice)
         ...
         % warn about repeat choice
         if(numattempts==2)
            DrawFormattedText(w, 'Don''t Repeat!',...
                    'center',30 ,...
                    [254 0 0]);
            Screen('Flip',w,0,1);
            fprintf('repeat button @ %f\n',timeAtResponse);
            subject.stimtime(trialnum).firstbadresponse=timeAtResponse - StartOfRunTime;
         end   
            
         % poll for an acceptable key
