  ...
  try
     ...
     Instructions = { ...
        ...
        [ 'You can not choose the same fruit twice in a row\n' ...
          ...
          'You can win up to $24 in addition to your participation compensation\n' ...
        ], ...
      }; 
